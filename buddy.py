...
class Buddy:
    ...
    def home(self, duration_ms=None, max_speed=None, acc=50, wait=False,
             include_gripper=False):
        """Drive every kinematic joint to its 0-degree user-frame position.
        ...
        to fold it in (it will move to 0 degrees too, which closes the
        jaws on a default config).
        """
